...
fluxRatio = [0.6478124125]                              # flux ratios from BF areas
fluxRatioErr = [0.02824]                                # error on the above
...
isofiles = ['fehm1afep0_age1.txt', 'fehm1afep0_age1p75.txt', 'fehm05afep0_age1.txt', 
    'fehm048afep0p8_age1.txt', 'fehp00afep0_age1.txt', 'fehp02afep0_age15.txt']
...
isofiles = ['fehm048afep0p8_age1.txt', 'fehm048afep0p8_age1p25.txt', 'fehm048afep0p8_age1p5.txt',
    'fehm00afep8_age1.txt', 'fehm00afep8_age1p25.txt', 'fehm00afep8_age2.txt']
...
plt.title(starId)
plt.legend()
plt.savefig('6131659HR.png')
plt.savefig('6131659HR.jpeg')
plt.show()