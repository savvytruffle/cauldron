...
BFfluxRatio = [0.8909515437]                            # flux ratios from BF areas
BFfluxRatioErr = [0.07272]                              # error on the above
KEBLATfluxratio = [0.9201]                              # KEBLAT flux ratio *NOT A SURFACE BRIGHTNESS*
KEBLATfluxratio_err = [0.05]                            # error on the above
KEBLATradiusratio = 0.8641                              # KEBLAT radius ratio
KEBLATradiusratio_err = 0.0275                          # error on the above
...
plt.title(starId)
plt.legend()
plt.savefig('figures/HRDiagrams/6781535_1.png')
plt.savefig('figures/HRDiagrams/6781535_1.jpeg')
plt.show()