...
KEBLATradiusratio = 1.149                               # KEBLAT radius ratio
KEBLATradiusratio_err = 0.020                           # error on the above
...
isofiles = ['isochrones/fehm048afep0p8_age1.txt', 'isochrones/fehm00afep8_age1.txt', 'isochrones/fehp02afep0_age2p5.txt', 'isochrones/fehp05afep0_age1.txt']
...
plt.title(starId)
plt.legend()
plt.savefig('figures/HRDiagrams/6864859_1.png')
plt.savefig('figures/HRDiagrams/6864859_1.jpeg')
plt.show()