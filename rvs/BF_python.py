...
#gaussoutfile = 'data/6449358/64493598gaussout.txt'; areaout = 'data/6449358/6449358BFArea.txt'
...
#widlimits = [0,16, 0,11]; rvneg = -90; rvpos = 200; ymin = -0.15; ymax = 1.2 #6449358 thicc
...
np.savetxt('6449358BFAreaout.txt', dataout.T, fmt = '%.5f')
